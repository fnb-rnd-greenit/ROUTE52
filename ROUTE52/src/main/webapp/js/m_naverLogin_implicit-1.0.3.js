 ...
 * @private
 */
	this.setButton = function(button_color,button_type,button_height,button_src) {
		...
		this.button_src = ((typeof(button_src)!='undefined') && (button_src != "") ) ? button_src : "";
	}
/**
 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='"+this.button_src+"' border='0' width='110' title='네이버 아이디로 로그인'></a> ";
		}
		else 
		{
