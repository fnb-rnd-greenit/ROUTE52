...
$(window).scroll(function() {
       if($(window).scrollTop() + $(window).height() == getDocHeight()) {
		$("#quickBox").show().animate({bottom:180},0)
		if (document.frm.click.value == "1") {
			$("#quickOpneBox").show().animate({bottom:180},0)
			$("#quickBox").hide();
		}
		document.frm.scroll.value = "1"
       } else {
			if (document.frm.scroll.value == "1") {
				document.frm.scroll.value = "2";
				$("#quickBox").show().animate({bottom:0},0)
				if (document.frm.click.value == "1") {
					$("#quickOpneBox").show().animate({bottom:0},0)
					$("#quickBox").hide();
				}
			}
	   }
...
/* join02.asp joinAgreeyList textarea - 190212 추가 */
$(document).ready(function(){
