...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/intro/m_intro.css?v=3'/>">
        ...
        <div class="intro_cont">
        	...
        	<div class="intro_btnWrap">
                <div class="intro_btn1">
                    <a href="<c:url value='/m_valley/a_index.do'/>"><img src="<c:url value='/images/intro/intro_btn1.png'/>"></a>
                </div>
                <div class="intro_btn2">
                    <a href="<c:url value='/m_hills/a_index.do'/>"><img src="<c:url value='/images/intro/intro_btn2.png'/>"></a>
                </div>
