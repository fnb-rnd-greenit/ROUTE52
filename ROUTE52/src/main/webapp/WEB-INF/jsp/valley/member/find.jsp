...
<div id="wrap">
	<div class="contents">
		...
		<div class="grayBgBox">
			<div class="findBox">
				<div class="findId">
					<span class="findTitle"><img src="<c:url value='/images/valley/login.png'/>" alt=""> 아이디를 잊으셨나요?</span>
					<div class="findIpBox">
						<ul class="loginInput">
							<li>
							  <input type="text" value="" placeholder="이름" id="txtFindIdName">
							</li>
							<li>
							  <input type="text" maxlength="20" placeholder="휴대폰번호" id="txtFindIdPhone">
							</li>
						</ul>
				...
				<div class="findId pw">
					<span class="findTitle"><img src="<c:url value='/images/valley/lock.png'/>" alt=""> 비밀번호를 잊으셨나요?</span>
					<div class="findIpBox">
						<ul class="loginInput">
							<li>
