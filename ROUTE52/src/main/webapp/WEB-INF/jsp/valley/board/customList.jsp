...
<div id="wrap">
	<div class="contents">
		<div class="myzoneTabList6">
			<a href="/valley/reservation/reservationCheck.do" class="">예약확인/취소</a>
			...
			<a href="/valley/board/list.do?bbsType=9" class="on">고객의소리</a>
		...
		<div class="btnBox">
			<a href="<c:url value='/valley/board/write.do?bbsType=9'/>" class="blueBtn">글쓰기</a>
		</div>
