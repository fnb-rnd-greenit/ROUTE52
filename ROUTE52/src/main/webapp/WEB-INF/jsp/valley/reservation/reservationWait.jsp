...
<script type='text/javascript' src="<c:url value='/js/valley/basic.js'/>"></script>
<script type="text/javascript">
	...
	function initCalendar(selector, year, month) {
		var sUrl = "<c:url value='/valley/reservation/getWaitCalendar.do'/>";
		var sParams = "";
	...
	function doSearch() {			
		...
		var sUrl = "<c:url value='/valley/reservation/getWaitTeeList.do'/>";
		var sParams = "";
...
<div id="wrap">
	<div class="contents">
		<div class="reserTabList">
			...
			<a href="<c:url value='/valley/reservation/reservationWait.do'/>" class="on">대기예약</a>
