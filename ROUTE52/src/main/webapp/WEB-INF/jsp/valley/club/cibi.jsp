...
<div id="wrap">
	<div class="contents">
		<div class="myzoneTabList4">
			...
			<a href="<c:url value='/valley/club/cibi.do'/>" class="on">CI/BI소개</a>
		...
		<div class="introTextBox">
			<div class="introLogoBox">
				<img src="<c:url value='/images/valley/introLogo.png'/>" alt="">
			</div>
