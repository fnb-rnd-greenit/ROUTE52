...
<div id="wrap">
	<div class="contents">
		<div class="myzoneTabList4">
			...
			<a href="<c:url value='/valley/club/history.do'/>" class="on">연혁</a>
		...
		<div class="history1" style="display:block">
			<img src="<c:url value='/images/valley/history01.png'/>" alt="">
		</div>
		<div class="history2" style="display:none">
			<img src="<c:url value='/images/valley/history02.png'/>" alt="">
		</div>
		<div class="history3" style="display:none">
			<img src="<c:url value='/images/valley/history03.png'/>" alt="">
		</div>
		<div class="history4" style="display:none">
			<img src="<c:url value='/images/valley/history04.png'/>" alt="">
		</div>
