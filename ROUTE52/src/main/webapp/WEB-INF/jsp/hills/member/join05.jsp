	...
	<div class="contents">
		...
		<div class="joinGrayBg">
			<ul class="joinInfoBox">
				<li class="infoList"><span class="orangeRed"> *</span> 이 름</li>
				<li><input type="text" id="txtName" style="width:318px"></li>
			</ul>
			<ul class="joinInfoBox">
				<li class="infoList"><span class="orangeRed"> *</span> 핸드폰</li>
				<li>
					<input type="text" id="txtPhone1" style="width:90px;margin-right:5px">-
					<input type="text" id="txtPhone2" style="width:100px;margin-right:5px">- 
					<input type="text" id="txtPhone3" style="width:100px;">
				</li>
			</ul>	
			<ul class="joinInfoBox" id="certifyContainer">
				<li class="infoList"></li>
				<li><input type="text" class="idInput" id="txtCerCode"></li>
				<li><div class="overlap orangeBtn" onclick="doCertification()" id="btnSend" style="cursor:pointer;">인증번호전송</div></li>
				<li><div class="overlap orangeBtn" id="btnConfirm" onclick="doConfirmCertification()" style="cursor:pointer;">확인</div></li>
			</ul>
		...
		<div class="btnBox">
			<a href="javascript:doNext()" class="orangeBtn">다 음</a>
		</div>
	</div><!-- contents End -->
</div>
