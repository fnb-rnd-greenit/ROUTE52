	...
	function getSelectBox() {
		...
		mAjax(sUrl, sParams, function(data) {
			if(data.resultCode == "0000") {
				...
				var area = "${sessionScope.msMember.area}";
				if(area != null && area != "") {
					$("#selArea").val(area);	
				}
			} else {
...
<div id="wrap">
	<div class="contents">
		<div class="myzoneTabList7">
			...
			<a href="<c:url value='/hills/member/memModify.do'/>" class="on">회원정보수정</a>
		</div>

		<div class="subTitle">
			<span class="title">회원 정보 수정</span>
			<span class="titleDes"></span>
			<a href="<c:url value='/hills/member/withdraw.do'/>" class="withDrawBtn">회원탈퇴</a>
		</div>
		...
		<div class="grayBgBox bgBottom">
			...
			<div class="necessa-InputBox">
				<div class="necessa-LeftBox">
					...
					<ul class="necessaList">
						...
						<li style="margin-bottom:10px;" id="txtPwRuleMessage">
							<span class="orange smfont">패스워드 생성규칙</span><br>
				...
				<div class="necessa-RightBox">				
					...
					<ul class="necessaList">
						<li class="titleBox">지역</li>
						<li class="cont">
							<select name="" id="selArea" class="select-arrow2">
							</select>
						</li>
					</ul>
					<ul class="necessaList">
						<li class="titleBox">자택 주소</li> 
						<li class="cont"><input type="text" class="txt mid" id="txtZipCode" style="vertical-align:top" readonly><input type="button" value="우편번호검색" class="orangeBtn mainBtn" onclick="daumPostcode('#txtZipCode', '#txtHomeAddress1')"></li>
					...
					<ul class="necessaList">
						...
						<div class="phoneSnsBox">
							<p class="txt"><span class="red">* </span>SMS수신동의 하시면 서원힐스 컨트리클럽에서 보내는 공지 및 정보를 휴대폰으로 <br>&nbsp;&nbsp;&nbsp;받아 보실 수있습니다.</p>
			...
			<div class="necessa-InputBox">
				<div class="necessa-LeftBox">
					...
					<ul class="necessaList">
						...
						<li class="cont"><input type="text" class="txt mid" style="vertical-align:top" id="txtCoZipCode"><input type="button" value="우편번호검색" class="orangeBtn mainBtn "onclick="daumPostcode('#txtCoZipCode', '#txtCoAddress1')"></li>
						<li class="titleBox"></li>
