...
<script type="text/javascript">
	...
	function succPhoneCheck(name, phone, birth, gender) {
		var sUrl = "<c:url value='/hills/member/join04.do'/>";
...
<div id="wrap">
	<div class="contents">
		<div class="joinTab">
			...
			<a href="javascript:void(0)" class="on">02.회원실명확인</a>
			<a href="javascript:void(0)" class="">03.회원정보입력</a>
		</div>
		<div class="subTitle subBottom">
			<span class="title">회원 실명확인</span>
			<span class="titleDes"></span>
		</div>
		<div class="subLine"></div>

		<div class="grayBgBox">
			<div class="midTitleBox joinTop">
				<span class="commonDot"> 실명확인 및 가입여부 확인</span>
			</div>
			<div class="hpIpBox" onclick="onLoadPhoneCheckPopup()">
				<div class="hpBox">
					<img src="<c:url value='/images/hills/icon_hp.png'/>" alt="">
					<span class="orange">휴대폰</span>
					<p>본인 명의의 휴대폰으로 인증번호를 받은 후 <br>
					가입하실 수 있습니다.</p>
				</div>
				<%-- <div class="hpBox">
					<img src="<c:url value='/images/hills/icon_ipin.png'/>" alt="">
					<span class="orange">IPIN</span>
					<p>아이핀 인증을 받은 후<br> 가입하실 수 있습니다. </p>
				</div> --%>				
			</div>
		</div>
