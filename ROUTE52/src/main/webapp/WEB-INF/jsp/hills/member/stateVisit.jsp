...
<script type="text/javascript">
	...
	function doSearch() {
		...
		var sUrl = "<c:url value='/hills/member/getEnHistoryLog.do'/>";
		var sParams = "";
		...
		mAjax(sUrl, sParams, function(data) {
			if(data.resultCode == "0000") {
				...
				if(rowData.length == 0) {
					if(rowData.length == 0) {
						var row = $("<tr><td colspan='6'><span class='txt'> 등록된 내장현황이 없습니다. </span></td></tr>");
						row.appendTo(tBody); 
					}
				}
				...
				for(i=0; i<rowData.length; i++) {
				    ...
				    var col3 = $("<td>" + enDay + "</td>");
				    var col4 = $("<td>" + rowData[i].EN_COS_NM + "코스</td>");
				    var col5 = $("<td>" + sTime + "</td>"); 
				    var col6 = $("<td>" + eTime + "</td>"); 
...
<div id="wrap">
	<div class="contents">
		<div class="myzoneTabList7">
			...
			<a href="<c:url value='/hills/member/stateVisit.do'/>" class="on">내장현황</a>
