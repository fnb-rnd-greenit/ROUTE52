...
<script type="text/javascript">
	...
	function doDeleteMember() {
		var sUrl = "<c:url value='/hills/member/doDeleteMember.do'/>";
		var sParams = "";
...
<div id="wrap">
	<div class="contents">
		...
		<div class="grayBgBox">
			<p class="withdrawLtxt title">
				서원힐스 컨트리클럽 사이트를 이용해주셔서 진심으로 감사 드립니다. <br>
		...
		<div class="btnBox">
			...
			<a href="<c:url value='/hills/member/memModify.do'/>" class="motion">정보변경</a>
		</div>
