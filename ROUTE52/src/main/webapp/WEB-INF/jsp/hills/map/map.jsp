...
<div id="wrap">
	...
	<div class="contents" id="map1">
		...
		<div class="map_wrap">
			<div class="mapBox">
			<img src="<c:url value='/images/hills/map/map.jpg'/>">
			<a class="left_btn" href="http://naver.me/FDJ9CqHU" target="_blank"><img src="<c:url value='/images/hills/map/arwBox.png'/>"> 네이버지도 보기</a>
				<a class="right_btn1" href="http://m.its.go.kr/nticMap2" target="_blank"><img src="<c:url value='/images/hills/map/arwBox.png'/>"> 실시간교통정보(국도 1호선)</a>
				<a class="right_btn2" href="http://m.its.go.kr/nticMap2" target="_blank"><img src="<c:url value='/images/hills/map/arwBox.png'/>"> 실시간교통정보(국도 39호선)</a>
			</div>
		</div>
	</div>
	...
	<div class="contents" id="map3">
		...
		<div class="map_wrap">
			<div class="mapBox">
				<img src="<c:url value='/images/hills/map/map2.jpg'/>">
				<a class="left_btn" href="https://map.naver.com/?edid=11613479&sText=7Iug7Y%2BJSUM%3D&elng=64fe6dc44ee80f86355471cfbeffc9f3&sdid=19416772&dtPathType=2&menu=route&lng=4f3daae47d9e4b540ec93d0154ac402a&eelat=b5f90b82bf48800877b746e0b2b2bf02&mapMode=0&elat=43c90128d5b316adf8d17d3d895f0b73&pathType=0&eText=7ISc7JuQ67C466as7Luo7Yq466as7YG065%2B9&slng=f1835cc8a95ef09e88f0a24c64a9399a&eelng=dbe50211e2983da6161e6b5dfc279c7f&eType=SITE&slat=1393894b6df4e7336bd05a30df5e1015&sType=SITE_1&lat=898a556ec75bf1c48e0b5d6b77106f46&dlevel=7&enc=b64" target="_blank"><img src="<c:url value='/images/hills/map/arwBox.png'/>">실시간 빠른길 찾기</a>
				<a class="right_btn1" href="http://m.its.go.kr/nticMap2" target="_blank"><img src="<c:url value='/images/hills/map/arwBox.png'/>"> 실시간교통정보(국도 1호선)</a>
				<a class="right_btn2" href="http://m.its.go.kr/nticMap2" target="_blank"><img src="<c:url value='/images/hills/map/arwBox.png'/>"> 실시간교통정보(국도 39호선)</a>
			</div>
			<h2> &#8226; 제2자유로</h2>
			<h3>1. 신평IC - 2. 법곳IC 우회전 - 3. 산내교차로 우회전 - 4. 광탄IC 직진 - 5.방축교차로 우회전 - 6.방축2교차로 직진(광적,양주방향) - 7. 서원힐스 도착</h3>	
		</div>
	</div>
