...
<script type="text/javascript">
	...
	function doRegistMember() {
		var sUrl = "<c:url value='/hills/reservation/doRegistMember.do'/>";
		var sParams;
		var sData = "";
...
<div id="wrap">
	<div class="contents">	
		...
		<table class="commonTable tableLine">
			...
			<tr>
				<td rowspan="3" style="border-bottom:1px solid #45454f" id="txtCos"></td>
				<td rowspan="3" style="border-bottom:1px solid #45454f" id="txtTime"></td>
				<!-- <td>
				...
				<td><a href="javascript:doResetMember(1)"><img src="<c:url value='/images/hills/initial.png'/>" alt=""></a></td>
			</tr>
			<tr>
				<!-- <td>
				...
				<td><a href="javascript:doResetMember(2)"><img src="<c:url value='/images/hills/initial.png'/>" alt=""></a></td>
			</tr>
			<tr>
				<!-- <td>
				...
				<td><a href="javascript:doResetMember(3)"><img src="<c:url value='/images/hills/initial.png'/>" alt=""></a></td>
			</tr>
			<%-- <tr>
				<td>
				...
				<td><a href="javascript:doResetMember(4)"><img src="<c:url value='/images/hills/initial.png'/>" alt=""></a></td>
			</tr> --%>
