	...
	<div id="championTop">
		<div class="chTopBox">
			...
			<div class="chtopBox_con">
				...
				<ul>
					<li id="headerTab6" onclick="location.href = '<c:url value='/hills/contents/big2final.do'/>'">BIG2대회 리뷰</li>
					<li id="headerTab1" onclick="location.href = '<c:url value='/hills/champion/champion.do'/>'">대회요강</li>
					<li id="headerTab2" onclick="location.href = '<c:url value='/hills/champion/trumpy.do'/>'">시상내역</li>
					<%-- <c:choose>
