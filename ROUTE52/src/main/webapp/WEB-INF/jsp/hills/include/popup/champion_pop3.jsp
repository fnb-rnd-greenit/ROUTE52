...
<script type="text/javascript">
	...
	function doApply() {
		...
		sParams += String.format("ctDiv={0}", "3");
...
<div id="championPopup1" class="champContent">	
	<div class="champConBox">
		...
		<div class="champInfo2">
			<h2>"서원밸리·서원힐스 <span>연단체 챔피언십</span>"</h2>
			<h4>서원밸리컨트리클럽이 주최하는 <br><strong>연단체 챕피언십</strong>에지금 참가하세요. <br>
			다양하고 푸짐한 시상품들이준비 되어있습니다. <br>
			골퍼들의 도전을 기다립니다! </h4>			
		</div>
		<div class="btnBox3">
			...
			<a href="<c:url value='https://kr.object.ncloudstorage.com/contents/seowon-member/2019_%EC%9A%B0%EC%88%98%EC%97%B0%EB%8B%A8%EC%B2%B4_%EC%B1%94%ED%94%BC%EC%96%B8%EC%8B%AD_%EC%B0%B8%EA%B0%80_%EC%8B%A0%EC%B2%AD%EC%84%9C.doc'/>" class="darkgray2"><span>아이콘</span> 신청서 다운로드</a>
		</div>
	</div>	
