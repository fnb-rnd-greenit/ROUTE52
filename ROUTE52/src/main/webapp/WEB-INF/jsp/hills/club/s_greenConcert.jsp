...
<div id="wrap">
	<div class="contents">
		<div class="myzoneTabList5">
			<a href="<c:url value='/hills/club/s_greenConcert.do'/>" class="on">그린콘서트</a>	
		...
		<ul class="dashedBox" style="width: 835px;">
			<li class="grayTitle bold">그린콘서트는 매년 5월 넷째주 토요일에 열리는 글로벌 자선콘서트</li>
		...
		<p id="open_content" style="display:none; text-align:center;"><img src="<c:url value='/images/hills/award.png'/>" width="" alt="표창장" /></p>
		<script>
		...
		<div class="graphImg"><img src="<c:url value='/images/hills/graph.png'/>" alt=""></div>
