...
<div id="wrap">
	<div class="contents">
		<div class="myzoneTabList5">
			...
			<a href="<c:url value='/hills/club/s_greenTable.do'/>" class="on">그린테이블</a>	
		...
		<div class="greenTableBox">
			<img src="<c:url value='/images/hills/greentable_01.png'/>" class="tableImg">
			<div class="tableImgBox">
				<div class="tableImg2">
					<img src="<c:url value='/images/hills/greentable_02.png'/>" alt="">			
				</div>
				<div class="rollingBox">
					<div class="rollingImg">
						<img src="<c:url value='/images/hills/greentable_03_1.png'/>">
						<img src="<c:url value='/images/hills/greentable_03_2.png'/>">
						<img src="<c:url value='/images/hills/greentable_03_3.png'/>">
						<img src="<c:url value='/images/hills/greentable_03_4.png'/>">
						<img src="<c:url value='/images/hills/greentable_03_5.png'/>">
						<img src="<c:url value='/images/hills/greentable_03_6.png'/>">								
					</div>
				</div>	
			</div>
			<img src="<c:url value='/images/hills/greentable_04.png'/>" class="tableImg">
		</div>
