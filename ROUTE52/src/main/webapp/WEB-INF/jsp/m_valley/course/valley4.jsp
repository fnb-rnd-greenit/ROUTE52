...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_valley/course/valley4.png'/>" alt="밸리 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_valley/balloon.png'/>" alt="">&nbsp;코스가 평탄해 부담감 없이 플레이할 수 있는 코스로 자작, 단풍, 느티나무 수림대가 형성되어 있어 편안한 분위기를 더합니다. 슬라이스를 주의해야 하며 세컨 샷은 카트도로 끝의 그늘집을 보고 날립니다.</div>
				</li>
				<li class="holeInfo">
