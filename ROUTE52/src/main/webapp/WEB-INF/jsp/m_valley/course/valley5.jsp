...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_valley/course/valley5.png'/>" alt="밸리 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_valley/balloon.png'/>" alt="">&nbsp;티잉그라운드 앞에서 내려다보이는 해저드가 다소 부담스러운 홀입니다. 그러나 기량에 따라 적절한 공략지점을 선택하면 순조롭게 플레이할 수 있습니다. 티샷은 해저드의 오른쪽 끝지점을 보고 날리는 것이 좋고 해저드 뒤의<br>
					벙커를 주의해야 합니다.</div>
				</li>
				<li class="holeInfo">
