...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_valley/course/seowon9.png'/>" alt="서원 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_valley/balloon.png'/>" alt="">&nbsp;티샷에 따라 성공적인 세컨 샷을 기대할 수 있으므로 전략적이고 정확한 티샷이 요구됩니다.
