...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_valley/course/valley9.png'/>" alt="밸리 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_valley/balloon.png'/>" alt="">&nbsp;인코스의 마지막 홀로 평탄한 코스이므로 편안한 마음으로 파를 기록할 수 있습니다.
					티샷은 티잉그라운드에서 180야드 거리에 있는 벙커를 기준으로 날리되 필요 이상의 욕심을 부리기 보다 차분한 마음으로 라운드를 마무리합니다.</div>
				</li>
				<li class="holeInfo">
