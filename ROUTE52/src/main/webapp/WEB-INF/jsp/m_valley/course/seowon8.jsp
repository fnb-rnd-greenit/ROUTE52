...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_valley/course/seowon8.png'/>" alt="서원 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_valley/balloon.png'/>" alt="">&nbsp;레귤러 티에서부터 그린의 너머까지 홀의 왼쪽에 자리한 거대한 연못이 감탄을 자아내는 홀입니다.<br> 
