...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_valley/course/valley1.png'/>" alt="밸리 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_valley/balloon.png'/>" alt="">&nbsp;전체적으로 왼쪽으로 굽은 도그렉홀 티샷은 오른쪽의 큰 잣나무 부근을 겨냥합니다. 티샷 낙하지점의 페어웨이<br> 
