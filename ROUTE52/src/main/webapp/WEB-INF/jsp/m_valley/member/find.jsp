...
<div id="wrap">
	<div class="mainTitle">
		<img src="<c:url value='/images/m_valley/titleDot.png'/>" alt=""> 회원가입 <img src="<c:url value='/images/m_valley/titleDot.png'/>" alt="">
	</div>
	<div class="contents">
		<div class="grayBg">
			<div class="loginCont bgBottom">
				<p class="loginTitle"><img src="<c:url value='/images/m_valley/login.png'/>" alt="">아이디를 잊으셨나요?</p>
			...
			<div class="loginCont">
				<p class="loginTitle"><img src="<c:url value='/images/m_valley/lock.png'/>" alt="">비밀번호를 잊으셨나요?</p>
				<div class="logInputBox">
					<div class="loginInput">
			...
			<div class="loginTxt">
				...
				<a href="<c:url value='/m_valley/member/join02.do'/>" class="joinBtn">회원가입</a>
			</div>
