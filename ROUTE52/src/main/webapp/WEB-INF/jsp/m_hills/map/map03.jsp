...
<div id="wrap">
	...
	<ul class="mapTabList3">			
			...
			<li class="on"><a href="<c:url value='/m_hills/map/map03.do'/>">제2자유로</a></li>
	...
	<div class="contents">
		<div class="mapWrap">
			<div class="mapImg">
			<img src="<c:url value='/images/m_hills/map/map2.jpg'/>">
			</div>
			<div class="mapBox">
			<a class="mapbtn1" href="https://map.naver.com/?edid=11613479&sText=7Iug7Y%2BJSUM%3D&elng=64fe6dc44ee80f86355471cfbeffc9f3&sdid=19416772&dtPathType=2&menu=route&lng=4f3daae47d9e4b540ec93d0154ac402a&eelat=b5f90b82bf48800877b746e0b2b2bf02&mapMode=0&elat=43c90128d5b316adf8d17d3d895f0b73&pathType=0&eText=7ISc7JuQ67C466as7Luo7Yq466as7YG065%2B9&slng=f1835cc8a95ef09e88f0a24c64a9399a&eelng=dbe50211e2983da6161e6b5dfc279c7f&eType=SITE&slat=1393894b6df4e7336bd05a30df5e1015&sType=SITE_1&lat=898a556ec75bf1c48e0b5d6b77106f46&dlevel=7&enc=b64" target="_blank"><img src="<c:url value='/images/m_hills/map/arwBox.png'/>"> 빠른길찾기</a>
			</div>
			<div class="mapText">
				<h2>&#8226; 제2자유로</h2>
