...
<div id="wrap">
	<div class="mainTitle">
		<img src="<c:url value='/images/m_hills/titleDot.png'/>" alt=""></span>  
			...
			<c:if test="${bbsType eq '21' || bbsType eq '22' || bbsType eq '23' || bbsType eq '24'}">
				대회안내
			</c:if>
		...
		<span><img src="<c:url value='/images/m_hills/titleDot.png'/>" alt="">
	</div>
	...
	<div class="contents">
		...
		<ul class="btnBox">
			...
			<li class="orangeBtn"><a href="javascript:writeBoard();">등록</a></li>
			</c:if>
			<c:if test="${actionFlag == 'update'}">
			<li class="orangeBtn"><a href="javascript:writeBoard();">수정</a></li>
			</c:if>			
		</ul>
