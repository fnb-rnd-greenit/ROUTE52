...
<script type="text/javascript">
				...
				for(i=0; i<rowData.length; i++) {
					...
					if(rowData[i].BBSTYPE == "1") {
						...
						if(imageUrl != null && imageUrl != "" && folderName != null && folderName != "") {
							...
							imageUrl = "<c:url value='/images/m_hills/no_img.jpg'/>";
						} 
	...
	function onClickRow(i) {
		var sUrl = "<c:url value='/m_hills/board/view.do'/>";
		var sParams = "";
				...
				<div class="contents">
						<div class="borderBg">
							...
							<div class="eventMoreBtn" id="btnMorePage" onclick="doMorePage()">
								<ul class="moreBtn">
									<li>더보기</li>
									<li><img src="<c:url value='/images/m_hills/sc_arrow.png'/>" alt=""></li>						
								</ul>
							</div>		
						</div>  
						<c:if test="${sessionScope.msMember.webAdmin == 'Y' && bbsType ne '51'}">    
							<a  class="orangeBtn closeBtn"href="<c:url value='/m_hills/board/write.do?bbsType=${bbsType}'/>">글쓰기</a>
						</c:if>		
					</div>
