...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_hills/course/south5.png'/>" alt="사우스 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_hills/balloon.png'/>" alt="">&nbsp;기념 사진을 찍기에 손색이 없는 홀이다. 그린에 원온 하여야 좋은 스코어를 얻을 수 있을 것이다.
