...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_hills/course/west8.png'/>" alt="웨스트 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_hills/balloon.png'/>" alt="">&nbsp;전체적으로 오르막 홀이므로 티샷 후 클럽 선택시 여유 있게 한클럽 이상 잡으면 좋을 것이다.
					그린 공략시 오르막 때문에 경사면이 보이지 않을 것이며 가까워 보일 것이나 엣지부터 그린 중앙 까지는 거리가 있다.</div>
				</li>
				<li class="holeInfo">
