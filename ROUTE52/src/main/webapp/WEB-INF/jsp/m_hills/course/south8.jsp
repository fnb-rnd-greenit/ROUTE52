...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_hills/course/south8.png'/>" alt="사우스 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_hills/balloon.png'/>" alt="">&nbsp;사우스코스의 대표적인 홀이다. 우측의 워터 해저드는 플레이어의 심장박동수를 높일 것이다.
					긴장을 가라 앉히고 전략적으로 플레이해야 실수가 없을 것이다. 좌측 벙커 우측 끝을 보며 티샷을 한다면 실수를 줄일 수 있을 것이다. 장타자의 경우 작은 벙커를 바로 넘겨도 유리 할 것이다.</div>
				</li>
				<li class="holeInfo">
