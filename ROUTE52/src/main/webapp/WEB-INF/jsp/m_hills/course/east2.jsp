...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_hills/course/east2.png'/>" alt="이스트 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_hills/balloon.png'/>" alt="">&nbsp;왼쪽 산자락의 화려한 관목과 그린 오른쪽의 연못이 한 눈에 내려다보이는 파3홀로 여유롭게 플레이 가능하다.</div>
				</li>
				<li class="holeInfo">
