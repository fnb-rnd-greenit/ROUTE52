...
<div id="wrap">
	...
	<div class="contents">
		...
		<div class="courseBg">
			...
			<div class="courseImg"><img src="<c:url value='/images/m_hills/course/west3.png'/>" alt="웨스트 코스 이미지"></div>
			...
			<ul class="courseInfoBox">
				...
				<li class="holeExplainBox">
					<div class="holeExplain"><img src="<c:url value='/images/m_hills/balloon.png'/>" alt="">&nbsp;우측으로 흐르는 페어웨이 경사만 유의 한다면 무난한 홀이 될 것이다.
