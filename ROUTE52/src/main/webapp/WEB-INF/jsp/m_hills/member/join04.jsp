...
<script type="text/javascript">
	...
	function setSelectBox(birth) {
		...
		for(i=1; i<=31; i++) {
			var month = i > 9 ? i : "0" + i;
			$("#selBirth3").append("<option value='" + month + "'>" + i + "</option>");
		}
...
<div id="wrap">
	...
	<div class="contents">
		<div class="grayBg">
			<div class="joinBoxList">
				<ul class="joinInfoBox">
					...
					<li><input type="text" class="idInput" id="txtId"><a class="overlap orangeBtn" onclick="duplicateCheckId()">중복확인</a></li>
				</ul>
		...
		<ul class="btnBox">
			...
			<li class="orangeBtn"><a href="javascript:signUpForLocal()">완료</a></li>			
		</ul>
	</div><!-- contents End -->
