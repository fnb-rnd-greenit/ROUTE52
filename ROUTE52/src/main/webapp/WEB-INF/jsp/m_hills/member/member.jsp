...
<div id="wrap">
	...
	<div class="contents">	
		<div class="midTitleBox">
			...
			<a class="memberBtn" href="<c:url value='/m_hills/member/modify.do'/>">추가정보 확인</a>			
		</div>
		<div class="grayBg">
			<div class="memberBoxList">
				...
				<div class="ListUnderLine">
					<ul class="memberInfoBox">
						...
						<li class="infoConent"><select id="selArea" style="width: 50%;" class="select-arrow2"></select></li>     
					</ul>
				</div>
		...
		<a class="orangeBtn closeBtn" href="javascript:doSave()">수정완료</a>
