...
<div id="wrap">
	<div class="mainTitle">
		<img src="<c:url value='/images/m_hills/titleDot.png'/>" alt=""> 회원탈퇴 <img src="<c:url value='/images/m_hills/titleDot.png'/>" alt="">
	</div>
	<div class="contents">	
		...
		<ul class="btnBox">
			...
			<li class="orangeBtn"><a href="javascript:doDeleteMember()">회원탈퇴</a></li>
