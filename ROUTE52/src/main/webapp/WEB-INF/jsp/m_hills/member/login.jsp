		...
		<div class="grayBg">
			<div class="loginCont">
				 ...
				 <div class="LogFindBtn">
					<a href="<c:url value='/m_hills/member/find.do'/>" class="id_Btn">아이디찾기</a>
					<a href="<c:url value='/m_hills/member/find.do'/>">비밀번호찾기</a>
				 </div>
				 <p class="loginTitle">SNS계정으로 간편가입 및 로그인이 가능합니다.</p>
